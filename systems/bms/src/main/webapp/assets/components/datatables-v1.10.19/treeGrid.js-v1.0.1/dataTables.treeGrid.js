    ...
    $.extend(TreeGrid.prototype, {
        fnConstruct: function (oInit) {
            ...
            dataTable.on('click', 'td.treegrid-control', function (e) {
                ...
                var layer = parseInt(td.find('div').css('margin-left') || 0, 10) / sLeft;
                ...
                var marginLeftNum = layer * sLeft + 'px';
                
                var tdText = td.text();
                var divHtm = '<div style="height: 37px; border-width: 0; width: 1px; float: left; margin: -9px 0px -9px -10px; border-left: 1px dashed #ccc;"></div>';
                td.html('').append(divHtm).append(icon).append(tdText);
                ...
                if (data.children && data.children.length) {
                    ...
                    data.children.forEach(function (item) {
                        ...
                        // treegridTd.find('div').css('marginLeft', left + 'px');
            ...
            dataTable.on('click', 'td.treegrid-control-open', function (e) {
                ...
                var index = undefined; // dataTable.row(getParentTr(e.target)).index();
                var td = $(dataTable.cell(getParentTd(e.target)).node());
